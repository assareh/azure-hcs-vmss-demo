...
# provider "consul" {
#   address    = trimprefix(data.terraform_remote_state.consul.outputs.consul_public_addr, "https://")
#   datacenter = "dc1"
#   token      = data.terraform_remote_state.consul.outputs.consul_root_token_secret_id
# }
